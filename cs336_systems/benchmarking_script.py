...
from cs336_basics.cs336_basics import BasicsTransformerLM
import torch
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_backward", type=bool, default=False)
    # device args
